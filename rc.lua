...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "c", function () awful.util.spawn( "code" ) end,
        {description = "code", group = "super"}),
    awful.key({ modkey }, "f", function () awful.util.spawn( "nemo" ) end,
        {description = "nemo", group = "super"}),
    ...
    --awful.key({ modkey1, altkey   }, "k", function() awful.util.spawn( "xautolock" ) end,
    --    {description = scrlocker, group = "alt+ctrl"}),
    awful.key({ modkey1, altkey   }, "l", function() awful.util.spawn( "xautolock -locknow" ) end,
        {description = scrlocker, group = "alt+ctrl"}),
